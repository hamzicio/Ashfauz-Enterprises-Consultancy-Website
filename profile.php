                            ...
                            <div class="topbar-left">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="fa fa-phone"></i> +92 333-2184070</a></li>
                                       <li><a href="#"><i class="fa fa-phone"></i>+92 343-32481831 </a></li>
...
<div class="row">
  ...
  <div class="col-lg-10">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="https://www.ashfauz.com/chalja">Chat</a></li>
...
<center><input type="file" name="url"> </center></br>

<input class="btn btn-info " type="submit" value="Click here to update" name="update">
 ...
 <p><button onclick="window.location.href=\'https://www.ashfauz.com/chalja\'">Chat</button></p>
</div>
</div>';
